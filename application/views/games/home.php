	  	...
	  	<div class="row">
	  		<div class="col s12" id="pregame">
	  			...
	  			<?php if(isset($games) && $games): ?>
	  				<p class="text-title">Resume Game : </p>
  				...
  				<?php endif;  ?>
  					<p>
				 	   <input name="game_id" type="radio" value="0" id="0" checked="true" />
				 	   <label for="0">Mulai Baru</label>
						</p>
	  				<p>
	  					<button class="btn waves-effect waves-light red darken-4 text-title" type="button" name="action" id="get_games">Go
		        ...
		        <div class="col s4">
		          <div class="card">
		            ...
		            <div class="card-action">
		              <a href="<?php echo base_url();?>material_parts">Mulai</a>
		            </div>
		          </div>
		        </div>
		        ...
		        <div class="col s4">
		          <div class="card" >
		            ...
		            <div class="card-action">
		              <a href="<?php echo base_url();?>material_regresi">Mulai</a>
		            </div>
		          </div>
		        </div>
		        ...
		        <div class="col s4">
		          <div class="card" >
		            ...
		            <div class="card-action">
		              <a href="<?php echo base_url();?>material_costs">Mulai</a>
		            </div>
		          </div>
		        </div>
		      </div>
